...
<template>
  ...
  <div class="block">
    ...
    <el-pagination
      ...
      :page-sizes="[100, 200, 300, 400, 'all']"
      :page-size="100"
...
| align               | 水平排列方式                                                                        | string   | left/center/right                                                         |                                             |
...
| layout              | 组件布局，子组件名用逗号分隔                                                                | String   | `sizes`, `prev`, `pager`, `next`, `jumper`, `->`, `total`, `slot`, `tips` | 'total, sizes, tips, prev, pager, next, jumper' |
